    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <p className="text-base sm:text-xl md:text-2xl text-white text-balance max-w-sm sm:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 animate-fade-in-subheading font-light">
          DAVNS Industries is an AI-driven startup developing advanced platforms, intelligent products, and real-time solutions through research and innovation.
        </p>
        ...
        <div className="text-center px-4 hidden sm:block overflow-hidden animate-fade-in-trust">
          <p className="text-sm text-white mb-6">Trusted by companies</p>
          <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
            <div className="flex items-center gap-8 opacity-60 hover:opacity-80 transition-all duration-500 animate-slide-left">
              <div className="flex items-center gap-8 whitespace-nowrap">
                <div className="text-base sm:text-lg font-semibold">Intecalic</div>
                <div className="text-base sm:text-lg font-semibold">Kushan Elevators</div>
                <div className="text-base sm:text-lg font-semibold">Sriviiyengar Foods</div>
                <div className="text-base sm:text-lg font-semibold">Motor Guardians</div>
                <div className="text-base sm:text-lg font-semibold">Vasantham Honey</div>
                <div className="text-base sm:text-lg font-semibold">Darkline Art</div>
              </div>
          ...
          <div className="relative overflow-hidden w-full max-w-sm mx-auto">
            ...
            <div className="flex items-center gap-6 opacity-60 animate-slide-left-mobile">
              <div className="flex items-center gap-6 whitespace-nowrap">
                <div className="text-sm font-semibold">Intecalic</div>
                <div className="text-sm font-semibold">Kushan Elevators</div>
                <div className="text-sm font-semibold">Sriviiyengar Foods</div>
                <div className="text-sm font-semibold">Motor Guardians</div>
                <div className="text-sm font-semibold">Vasantham Honey</div>
                <div className="text-sm font-semibold">Darkline Art</div>
              </div>
              {/* Duplicate for seamless loop */}
              <div className="flex items-center gap-6 whitespace-nowrap">
                <div className="text-sm font-semibold">Intecalic</div>
