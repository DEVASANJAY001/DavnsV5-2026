      ...
      <div className="bg-white rounded-b-[3rem] pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              Watch how DAVNS systems handle real customer interactions, intelligent automation, and 24/7 support.
            </p>
          </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center lg:h-[600px] space-y-6 lg:space-y-8 order-2 lg:order-1">
              ...
              >
                <h3 className="text-2xl lg:text-3xl font-bold text-slate-900 mb-4 lg:mb-6">
                  DAVNS Systems in Action
                </h3>

                <div className="space-y-3 lg:space-y-4 text-base lg:text-lg text-slate-700 leading-relaxed">
                  <p>
                    Our AI-powered platforms solve real problems by automating complex workflows, improving efficiency, and delivering intelligent solutions 24/7.
                  </p>

                  <p>
                    Every conversation you're watching represents a real-world application—whether it's customer support, industrial automation, or business intelligence.
                  </p>

                  <p className="text-lg lg:text-xl font-semibold text-slate-900">
                    This is how we drive innovation and real-world impact.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="p-4 lg:p-6 bg-slate-50 rounded-xl border-l-4 border-slate-900">
                  ...
                  <p className="text-xs lg:text-sm text-slate-600 mt-2">— Praveen, Car Dealership Owner</p>
                </div>
              </div>
            </div>
                        ...
                        <div className="bg-slate-900 px-6 py-4 text-white">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              <h3 className="font-semibold text-sm">DAVNS - AI Sales Agent</h3>
