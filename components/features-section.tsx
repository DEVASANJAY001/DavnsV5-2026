...
const AnimatedLeadsDemo = ({ isActive }: { isActive: boolean }) => {
  const [leads, setLeads] = useState([
    { name: "Nemal", score: 0, qualified: false },
    { name: "Vijay", score: 0, qualified: false },
    { name: "Srivi", score: 0, qualified: false },
  ])
...
const AnimatedIntegrationsDemo = ({ isActive }: { isActive: boolean }) => {
  const [connections, setConnections] = useState([
    { name: "Mike Rodriguez", connected: false },
    { name: "Car Dealership", connected: false },
    { name: "Owner - Jayanth", connected: false },
    { name: "Some other name", connected: false },
  ])
...
const features = [
  {
    ...
    description:
      "Intelligent systems that automate workflows, detect patterns, and improve operational efficiency across your organization.",
  ...
  },
  {
    ...
    description:
      "AI-powered inspection systems, defect detection, and real-time monitoring solutions for manufacturing and quality assurance.",
  ...
  },
  {
    ...
    description:
      "Data-driven dashboards using Power BI and custom platforms for real-time business intelligence and decision-making.",
  ...
  },
  {
    ...
    description:
      "Scalable web and mobile applications tailored for business needs, built with modern technologies and best practices.",
  ...
  },
  {
    ...
    description:
      "We design and build innovative products from scratch based on real-world problems and comprehensive market research.",
  ...
  },
  {
    ...
    description:
      "Study existing platforms, identify inefficiencies, and develop new solutions using AI and cutting-edge technologies.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              Leverage our expertise in AI, automation, and software development to build intelligent platforms that
