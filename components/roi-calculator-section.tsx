      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-6">
            ...
            <span className="text-sm font-medium text-white/80">Our Clients</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto text-balance">
            We collaborate with forward-thinking companies and organizations to build intelligent platforms, scalable systems, and real-world solutions.
          </p>
        </div>
