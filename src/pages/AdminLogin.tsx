        ...
        <div className="w-full max-w-md relative z-10">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <div className="w-14 h-14 rounded-2xl bg-purple-100/80 border border-purple-200 text-[#7C3AED] flex items-center justify-center mx-auto mb-3.5 shadow-2xs">
            ...
            <div className="mt-6 pt-5 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-mono">
              ...
              <Link to="/" className="hover:text-slate-900 transition-colors inline-flex items-center gap-1 group">
