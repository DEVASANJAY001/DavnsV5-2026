...
import { Mail, Lock, User, Eye, EyeOff, Sparkles, ArrowRight, ShieldCheck } from "lucide-react"
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 pt-36 pb-20 relative overflow-hidden">
        ...
        <div className="w-full max-w-lg relative z-10">
          ...
          <motion.div
            ...
            className="bg-white rounded-[36px] border border-slate-200 shadow-2xl p-6 sm:p-9 backdrop-blur-xl relative overflow-hidden"
          >
            ...
            <div className="mt-6 pt-5 border-t border-slate-100 text-center">
              <Link
                to="/admin/login"
                className="text-xs text-slate-500 hover:text-[#7C3AED] font-mono flex items-center justify-center gap-1.5 transition-colors"
              >
